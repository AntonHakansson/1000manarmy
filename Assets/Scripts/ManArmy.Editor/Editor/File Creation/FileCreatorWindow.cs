...
public class FileCreatorWindow : EditorWindow
{
    ...
    private FileCreatorMode m_Mode;
    ...
    public void OnGUI()
    {
        m_Mode = (FileCreatorMode)EditorGUILayout.EnumPopup("File Type", m_Mode);

        Type[] selectedTypes = (m_Mode == FileCreatorMode.ScriptableObject) ? m_ScriptableObjectTypes : m_TemplateObjectTypes;
