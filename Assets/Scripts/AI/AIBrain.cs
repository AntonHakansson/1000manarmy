...
using System.Linq;
using UnityEngine;
using ManArmy.AI.Actions;
using ManArmy.AI.Goals;

namespace ManArmy.AI
{
    [RequireComponent(typeof(AISettings))]
    public class AIBrain : AIBehavior
    {
        ...
        {
            if (m_ActionQueue == null || m_ActionQueue.Count == 0 || m_ActionQueue.Peek() != m_Fallback)
            {
